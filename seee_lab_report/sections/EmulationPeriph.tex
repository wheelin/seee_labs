...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=16cm]{img/leds2.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=10cm]{img/emul_test_miniapp_init.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=10cm]{img/emul_test_miniapp_counting.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=10cm]{img/emul_test_miniapp_end.png}
		\caption{Frontend graphique de Qemu avec affichage 7 segments}
