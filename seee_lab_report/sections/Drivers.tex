...
\textbf{Travail réalisé: }\\\\
On lance la commande et on voit des lignes apparaitre avec le type, le code et le front du bouton pressé. 
\begin{figure}[H]
	\begin{center}
...
\end{lstlisting}
\textbf{Travail réalisé: }\\\\
Le texte est modifié et montre un grand espace entre le titre et le premier paragraphe.
\begin{figure}[H]
	\begin{center}
